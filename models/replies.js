const Reply = {
    ...
    onSendMessage: {
        text: '✍️ <b>Отправить сообщение</b>\n\n<i>Пожалуйста, не пиши Ане всякие гадости, ты ведь не хочешь испортить ей настроение? А хотя вряд ли у тебя получится.. Кстати она может и ответит тебе, если напишешь что-то хорошее</i>',
        options: {
            reply_markup: {
                keyboard: [
                    [{ text: '❌ Отмена' }]
